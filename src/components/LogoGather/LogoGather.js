            ...
            this.setState(
                {
                    ...
                    pointSize:
                        typeof this.pointSize === 'number' ? this.pointSize : this.state.pointSize,
                    update: true,
                },
                () => {
                    this.setState({
            ...
            <div style={{ position: 'relative' }}>
                ...
                <div className={`logo-gather-demo-edit-wrapper ${this.state.show ? 'open' : ''}`}>
                    ...
                    <ul>
                        ...
                        <li>
                            <RadioGroup onChange={this.onChangeRadio} defaultValue="a">
                                <Radio value="a">
                                    <img alt="hinh" src={this.defaultImage.a} height="30" />
                                </Radio>
                                <Radio value="b">
                                    <img alt="hinh" src={this.defaultImage.b} height="30" />
                                </Radio>
                                <Radio value="c">
                                    <img alt="hinh" src={this.defaultImage.c} height="30" />
                                </Radio>
                                <Radio
                                    key="d"
                                    value="d"
                                    className={`${this.state.isMobile ? 'none' : ''}`}
                                >
                                    Other
                                    <TweenOneGroup
                    ...
                    <div style={{ lineHeight: '32px' }}>
                        ...
                        <br />
                        Note: The picture size is square PNG or SVG, please make sure the image is
                        open across domains;
                    </div>
                </div>
            </div>
